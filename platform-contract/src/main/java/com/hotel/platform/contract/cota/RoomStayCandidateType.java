 ...
 *       &lt;attribute name="Quantity" use="required" type="{http://www.opentravel.org/OTA/2003/05}Numeric1to999" /&gt;
...
@XmlType(name = "RoomStayCandidateType")
@XmlSeeAlso({
    HotelSearchCriterionType.RoomStayCandidates.RoomStayCandidate.class
})
